        ...
        <div class="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div class="grid md:grid-cols-2 items-center gap-4 max-w-6xl w-full">
                <div class="border border-gray-300 bg-white rounded-lg p-6 max-w-md shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] max-md:mx-auto">
                    <form class="space-y-4" method="POST" action="controller/login_controller.php">
                        <div class="mb-8">
                            <h3 class="text-gray-800 text-3xl font-extrabold">Hello! Welcome back.</h3>
                            <p class="text-gray-500 text-sm mt-4 leading-relaxed">Login with the data you entered during Registration.</p>
                        </div>
                        ...
                        <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <a href="register.php" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
                    </form>
                </div>
